...
def main():
    ...
    params = Params("/content/DeepLearningProjectGroup4/hparams.yaml", args.model_name)
    ...
    if args.write_data:
        data = pd.read_csv('/content/DeepLearningProjectGroup4/image/train_full_image_data.csv')
    ...
    train_data = Dataset(params.data_dir, "train_full_image_data.csv", flatten=params.flatten)
    val_data = Dataset(params.data_dir, "val_16_image_data.csv", flatten=params.flatten)
