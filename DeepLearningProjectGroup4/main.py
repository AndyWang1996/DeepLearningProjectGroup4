...
def main():
    ...
    if args.write_data:
        ...
        print(len(data))
        data = data.append(pd.read_csv('/content/DeepLearningProjectGroup4/DeepLearningProjectGroup4/image/train_full_2_image_data.csv'))
        print(len(data))
        data = data.append(pd.read_csv('/content/DeepLearningProjectGroup4/DeepLearningProjectGroup4/image/train_full_3_image_data.csv'))
        print(len(data))
